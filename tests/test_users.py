...
sys.path.append('../week-3-day-2') # imports python file from parent directory
...
class UsersTests(unittest.TestCase):
    ...
    def test_too_long_username_registration(self):
        response = self.register('trefnuebrjbjsbjfbeubfuebjfbbvbbvjrebjvbejsbjfvbj', 'test@example.com', 'FlaskIsAwesome')
        self.assertIn(b'Field must be between 2 and 20 characters long.', response.data)
    ...
    def test_no_at_sign_email_registration(self):
